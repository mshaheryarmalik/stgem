...
class SimulationDataCollector:
    ...
    def collect_current_data(self, oob_bb=True, wrt="right"):
        ...
        is_oob, oob_counter, max_oob_percentage, oob_distance_left, oob_distance_right, oob_percentage = self.oob_monitor.get_oob_info(oob_bb=oob_bb, wrt=wrt)

        sim_data_record = SimulationDataRecord(**car_state._asdict(),
                                               is_oob=is_oob,
                                               oob_counter=oob_counter,
                                               max_oob_percentage=max_oob_percentage,
                                               oob_distance_left=oob_distance_left,
                                               oob_distance_right=oob_distance_right,
