...
myst-docutils-xml=myst_parser.parsers.docutils_:cli_xml</p>
...
<script>document.getElementById('searchbox').style.display = "block"</script>
    ...
    <div class="footer">
      ...
      |
      <a href="../../../../../_sources/venv/lib/python3.9/site-packages/myst_parser-0.18.0.dist-info/entry_points.txt"
