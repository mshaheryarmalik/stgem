...
"""
from verifai.features.features import Real
...
class DomainSampler(Model):
    """Abstract sampler class"""

    def __init__(self, domain = Real(), dimensions = 3):
        self.domain = domain
...
class BoxSampler(DomainSampler):
    ...
    def __init__(self, domain = Real(), dimension = 3):
